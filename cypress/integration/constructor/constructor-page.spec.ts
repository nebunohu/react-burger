...
describe('Service is available', () => {
  ...
  it('should open ingredient modal window', () => {
    cy.intercept({method: 'GET', url: `${API_URL}/ingredients`}, ingredients).as('getIngredients');
    
    cy.visit('/');
    cy.wait('@getIngredients');
    
    cy.get('[data-test-id="ingredient-item"]:first').as('ingredient')
    
    cy.get('@ingredient').as('ingredient').click();
    cy.get('[data-test-id="modal-header"]').as('modalHeader');
    cy.get('@modalHeader').contains(modalHeaderContent);

  })

  it('should close ingredient modal window by overlay click', () => {
    cy.intercept({method: 'GET', url: `${API_URL}/ingredients`}, ingredients).as('getIngredients');
    
    cy.visit('/');
    cy.wait('@getIngredients');

    cy.get('[data-test-id="ingredient-item"]:first').as('ingredient').click();
  ...
  it('should close ingredient modal window by close button click', () => {
    cy.intercept({method: 'GET', url: `${API_URL}/ingredients`}, ingredients).as('getIngredients');
  ...
  it('should close ingredient modal window by "Esc" button click', () => {
    cy.intercept({method: 'GET', url: `${API_URL}/ingredients`}, ingredients).as('getIngredients');
